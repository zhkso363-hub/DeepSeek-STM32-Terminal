...
#if defined (__GNUC__) /*------------------ GNU / ARM Compiler 6 -----------------*/
  #define __ASM            __asm                                      /*!< asm keyword for GNU Compiler / ARM Compiler 6 */
  #define __INLINE         __inline                                   /*!< inline keyword for GNU Compiler / ARM Compiler 6 */
...
#if defined ( __CC_ARM   ) && !defined(__clang__) /*------------------RealView Compiler (AC5 only) -----------------*/
